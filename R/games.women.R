...
#' @name games.women.2025
#' @title 2025 NCAA Women's Basketball Game-by-Game Results
#' @description This dataset contains the game results of the
#'   college women's basketball 2024-2025 season, identifying
#'   the game, the home and away teams, (using the ESPN ID system),
#'   the home and away scores, whether the game was played at a
#'   neutral arena, and whether the game went into overtime. Teams
#'   that are not in Division I are uniformly identified by the
#'   string 'NA' as their id.
#' @format data frame with 5820 rows and 7 variables
#' @source ESPN
NULL

#' @name games.women.2026
#' @title 2026 NCAA Women's Basketball Game-by-Game Results
#' @description This dataset contains the game results of the
#'   college women's basketball 2025-2026 season, identifying
#'   the game, the home and away teams, (using the ESPN ID system),
#'   the home and away scores, whether the game was played at a
#'   neutral arena, and whether the game went into overtime. Teams
#'   that are not in Division I are uniformly identified by the
#'   string 'NA' as their id.
#' @format data frame with 5867 rows and 7 variables
#' @source ESPN
NULL
