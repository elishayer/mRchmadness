...
#' @name pred.pop.men.2025
#' @title 2025 March Madness Population Pick Distribution
#' @description This dataset contains the percent of brackets submitted
#'   to ESPN that include each of the 64 teams in March Madness 2025
#'   reaching and winning in each successive round of the tournament.
#'   Accessed the evening of March 17, 2025.
#' @format data frame with 64 rows and 9 variables
#' @source \url{https://gambit-api.fantasy.espn.com/apis/v1/propositions?challengeId=257}
NULL

#' @name pred.pop.men.2026
...
#' @format data frame with 64 rows and 9 variables
#' @source \url{https://gambit-api.fantasy.espn.com/apis/v1/propositions?challengeId=277}
NULL
