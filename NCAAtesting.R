...
set.seed(42)
my.bracket = find.bracket22(bracket.empty = bracket.men.2021,
...
my.bracket = find.bracket22(bracket.empty = bracket.2022.test,
                          prob.matrix = prob.matrix.22,
                          num.candidates = 1000, num.sims = 1000,
...
draw.bracket(bracket.empty = bracket.2022.test, bracket.filled = my.bracket)
...
prob.matrix.22["43","41"]
rownames(prob.matrix.22)
